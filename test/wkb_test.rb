...
class WkbTest < Minitest::Test
  ...
  # Triangle: (lng=1,lat=2), (lng=3,lat=4), (lng=5,lat=2) — non-degenerate
  POLYGON_HEX = "01030000000100000004000000000000000000f03f00000000000000400000000000000840000000000000104000000000000014400000000000000040000000000000f03f0000000000000040"
