...
<h2>Key Features</h2>
<lu>
<li><strong>14 Coordinate Systems</strong> - LLA, ECEF, UTM, ENU, NED, MGRS, USNG, Web Mercator, UPS, State Plane, BNG, GH36, GH, HAM<br>
...
Geodetic is a Ruby gem for converting between geodetic coordinate systems. It provides a clean, consistent API for working with 14 coordinate systems, 16 geodetic datums, geoid height calculations, and geographic area computations.

## Coordinate Systems

Geodetic supports full bidirectional conversion between all 14 coordinate systems:
